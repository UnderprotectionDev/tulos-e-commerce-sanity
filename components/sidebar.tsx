...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <div
      className={`fixed inset-y-0 left-0 z-50 bg-[var(--dark-color)]/50 shadow-xl hoverEffect cursor-auto w-full ${
    ...
    >
      <motion.div
        ...
        ref={sidebarRef}
        className="min-w-72 max-w-96 bg-[var(--dark-color)] text-white/70 h-full p-10 border-r border-r-white flex flex-col gap-6"
      >
